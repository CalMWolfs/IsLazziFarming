...
class ConfigGuiForgeInterop : IModGuiFactory {
    ...
    override fun mainConfigGuiClass() = WrappedIsLazziFarmingConfig::class.java
    ...
    class WrappedIsLazziFarmingConfig(private val parent: GuiScreen) : GuiScreenElementWrapper(ConfigGuiManager.editor) {
